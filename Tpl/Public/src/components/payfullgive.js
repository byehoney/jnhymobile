	    ...
	    var that = this;
	     ...
	     $.ajax({
		      ...
		      success: function(data){
		      	...
		      	// var data = {"data":{"shoplist":[{"main_shop_name":"\u6d4b\u8bd5\u975e\u51e1\u95e8\u5e97","branch_shop_name":"\u897f\u5c71\u8def","shop_id":"2016112600077000000023306679"},{"main_shop_name":"\u6cf0\u5cb3\u5174\u6d0b\u8d85\u5e02","branch_shop_name":"\u65b0\u534e\u533a\u5e97","shop_id":"2016102500077000000019431622"}],"logo":{"url":"\/Public\/logo\/2088711\/2088711005018696\/4be3cfb4d20a47af71c3be824e1d9e43.png","id":"QexGRuhrT7-aSRMGy-TFuwAAACMAAQQD"},"sq":false},"info":"\u83b7\u53d6\u6570\u636e\u6210\u529f","status":1}
  ...
  handleSubmit = (e) =>{
	...
	this.props.form.validateFields(formValids, { force: true },(error, values) => {
      ...
      if (!error) {
        ...
        var formData={
          act_obj:'所有在支付宝口碑消费超过'+ values.min_cost +'元的人群',
          name:values.actName,
...
//      });
        ...
        $.ajax({
		      url: AJAX_URL+"/Couponphone/ajaxCreateMinus"+token,
		      type: 'POST',
		      data: formData,
		      dataType: 'json',
		      timeout: 40000,
    ...
    return (
      ...
      <form>
	        ...
	        <div className="am-list-item am-input-item" style={{paddingRight:0}}>
	        	<div className="am-input-label am-input-label-5">活动对象</div>
	        	<div className="am-input-control validRange">
				  	<span>支付宝支付满</span>
				  	<InputItem
					    {...getFieldProps('min_cost',{
					    	initialValue: 30,
			            	rules: [{pattern:/^[1-9]*[1-9][0-9]*$/, required: true, message: '请输入正确的金额' }]
					    })}
					    type='number'
				  	/>
				  	<span>元的顾客</span>
